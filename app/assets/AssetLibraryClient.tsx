...
export default function AssetLibraryClient() {
  ...
  return <main className="portal-page asset-library-page">
    ...
    {trustedMode && <section className="trusted-portrait-center" aria-label="Seedance可信人物中心"><header><div><span>SEEDANCE TRUSTED PORTRAITS</span><h2>可信人物中心</h2><p>方舟已拦截可能含真人的参考图。这里不是本地白名单：需要在方舟完成本人授权，取得 Asset ID，再把状态标为“已授权”。</p></div><strong>{assets.filter((asset) => asset.category === "character" && asset.arkAssetId && asset.portraitAuthorizationStatus === "authorized").length}/{assets.filter((asset) => asset.category === "character").length} 已授权</strong></header><div className="trusted-portrait-steps"><span><b>1</b>定位红框人物</span><span><b>2</b>在方舟提交可信人像授权</span><span><b>3</b>填写 Asset ID 并确认已授权</span><span><b>4</b>返回工作台恢复生成</span></div><div className="trusted-portrait-actions"><a href="https://console.volcengine.com/ark" target="_blank" rel="noreferrer">打开火山方舟控制台 ↗</a><a href="https://www.volcengine.com/docs/82379/2315856" target="_blank" rel="noreferrer">查看可信人像说明 ↗</a><button type="button" onClick={() => router.push("/studio")}>返回工作台</button></div></section>}
