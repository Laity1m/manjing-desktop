...
- 上一镜合格尾帧及 End State 进入下一镜 Start State；生产首帧和上一镜尾帧作为几何依据，而不是普通风格参考。
...
- 新增“半写实3D国漫”风格，区分于写意国漫电影感，并对人物图、生产首帧和视频统一执行非真人化风格锁定。
...
- 视频生产首帧仅在工作台内部参与视频请求与质量审核，不归档为分镜图，也不会出现在长期资产库。
